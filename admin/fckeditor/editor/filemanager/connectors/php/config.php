 ...
 * 
 * FCKSergiusD 2.0 - расширенный файловый менеджер - http://www.sergiusd.ru
 * Copyright (C) 2008 SergiusD (Демчук Сергей Васильевич)
 *
 * == BEGIN LICENSE ==
 *
...
$Config['UserFilesAbsolutePath'] = '/usr/local/customers/webs/chistyakof/chistyakoff.com.ua/userfiles/' ;
...
$Config['FileTypesAbsolutePath']['ImageThumb']= ($Config['UserFilesAbsolutePath'] == '') ? '' : $Config['UserFilesAbsolutePath'].'imageThumb/' ;
